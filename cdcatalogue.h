// Description: Declaration of a CDCatalogue class
...
public:
  ...
  /**
    ...
    *Does not insert and returns false if a CD with a matching artist and 
    *album name already exists in the registry
    ...
    *PARAM: disc = item to be inserted, its fields should not be empty 
    *std::string
  ...
  /**
    ...
    *Returns false if a CD with the same parameters does not exist in the 
    *catalogue
    *POST:  catalogue does not contain CD
    *PARAM: disc = item to be removed, its fields should not be empty 
    *std::string
  ...
  /**
    ...
    *PARAM: disc = item to be located, its fields should not be empty 
    *std::string
    */
  int Find(CD disc) const;
  
  /**
    *Removes all CDs from the catalogue with artist matching the provided 
    *argument
    *Returns false if there are not matching CDs or input is empty std::string,
    ...
    *there are no "empty" spaces in the array (i.e. an array with 5 items must 
    *occupy indices 0-4)
  ...
  bool Boycott(std::string dontlikeanymore);
  ...
  /*
    ...
    *POST: union contains CD of this and cat, with no duplicate CDs (both 
    *parameters matching).
    */
  ...
  /**
    ...
    *POST: intersection contains CDs in both this and cat (both parameters 
    *matching).
    */
